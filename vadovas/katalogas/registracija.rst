...
- Valstybės tarnautojas arba Valstybinės įstaigos darbuotojas, dirbantis pagal darbo sutartį:
  Registruokitės pasirinkę „Viešasis sektorius“
- Duomenų atvėrėjas, nepriklausantis valstybinei įstaigai: Registruokitės pasirinkę „Gyventojas“.
...
*Atsidarys El.Vartų langas „Duomenų teikimas į Atvirų duomenų portalą“: čia automatiškai surenkami ir atvaizduojami
registruojamo koordinatoriaus duomenys: vardas, pavardė, kontaktai.*
...
- Įkelkite institucijos vadovo (ar įgalioto darbuotojo) pasirašytą **koordinatoriaus paskyrimo raštą** \*.
   ...
   *Rašto formatas: el. parašu pasirašytas (.adoc).*
